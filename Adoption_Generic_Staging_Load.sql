...
SELECT MAG_ID, MAG_NAME, MAGTEMPLATES_ID, MAGTEMPLATES_NAME, 
ROW_ID, BRAND_ID, BRAND_NAME, SEASONS_ID, 
SEASON_YEAR, SEASON_NAME, SEASON_SHORTNAME, 'MAG_Name__c' AS SF_FIELDNAME, MAG_NAME AS FIELDVALUE, 998 AS SORT_ORDER, SEGMENT_COUNT, CREATE_DATE, MODIFIED_DATE 
FROM MAT_DELTA_SF_STAGING WHERE SF_FIELDNAME = 'Planning_Choice__c';
COMMIT;
...
SELECT MAG_ID, MAG_NAME, MAGTEMPLATES_ID, MAGTEMPLATES_NAME, 
ROW_ID, BRAND_ID, BRAND_NAME, SEASONS_ID, 
SEASON_YEAR, SEASON_NAME, SEASON_SHORTNAME, 'SEASON_SHORTNAME__c' AS SF_FIELDNAME, SEASON_SHORTNAME AS FIELDVALUE, 997 AS SORT_ORDER, SEGMENT_COUNT, CREATE_DATE, MODIFIED_DATE 
FROM MAT_DELTA_SF_STAGING WHERE SF_FIELDNAME = 'Planning_Choice__c';
COMMIT;
...
SELECT MAG_ID, MAG_NAME, MAGTEMPLATES_ID, MAGTEMPLATES_NAME, 
ROW_ID, BRAND_ID, BRAND_NAME, SEASONS_ID, 
SEASON_YEAR, SEASON_NAME, SEASON_SHORTNAME, 'Season_Year__c' AS SF_FIELDNAME, SEASON_YEAR AS FIELDVALUE, 996 AS SORT_ORDER, SEGMENT_COUNT, CREATE_DATE, MODIFIED_DATE 
FROM MAT_DELTA_SF_STAGING WHERE SF_FIELDNAME = 'Planning_Choice__c';
COMMIT;
...
SELECT MAG_ID, MAG_NAME, MAGTEMPLATES_ID, MAGTEMPLATES_NAME, 
ROW_ID, BRAND_ID, BRAND_NAME, SEASONS_ID, 
SEASON_YEAR, SEASON_NAME, SEASON_SHORTNAME, 'Season_Name__c' AS SF_FIELDNAME, SEASON_NAME AS FIELDVALUE, 995 AS SORT_ORDER, SEGMENT_COUNT, CREATE_DATE, MODIFIED_DATE 
FROM MAT_DELTA_SF_STAGING WHERE SF_FIELDNAME = 'Planning_Choice__c';
COMMIT;
...
A.SEASON_YEAR, A.SEASON_NAME, A.SEASON_SHORTNAME, 'Brand__c' AS SF_FIELDNAME, B.NAME AS FIELDVALUE, 991 AS SORT_ORDER, A.SEGMENT_COUNT, A.CREATE_DATE, A.MODIFIED_DATE 
...
WITH SHARED_UNIQUE AS
(
    SELECT DISTINCT MAGTEMPLATES_ID , ROW_ID, SHARED_UNIQUE  FROM  TBL_RPT_MAT_REPORTING
)
SELECT A.MAG_ID, A.MAG_NAME, A.MAGTEMPLATES_ID, A.MAGTEMPLATES_NAME, 
A.ROW_ID, A.BRAND_ID, A.BRAND_NAME, A.SEASONS_ID, 
A.SEASON_YEAR, A.SEASON_NAME, A.SEASON_SHORTNAME, 'Shared_Unique__c' AS SF_FIELDNAME,  B.SHARED_UNIQUE AS FIELDVALUE, 994 AS SORT_ORDER, SEGMENT_COUNT, CREATE_DATE, MODIFIED_DATE 
FROM MAT_DELTA_SF_STAGING A INNER JOIN SHARED_UNIQUE B ON A.MAGTEMPLATES_ID = B.MAGTEMPLATES_ID AND A.ROW_ID = B.ROW_ID
WHERE A.SF_FIELDNAME = 'Planning_Choice__c'
...
SELECT A.MAG_ID, A.MAG_NAME, A.MAGTEMPLATES_ID, A.MAGTEMPLATES_NAME, 
A.ROW_ID, A.BRAND_ID, A.BRAND_NAME, A.SEASONS_ID, 
A.SEASON_YEAR, A.SEASON_NAME, A.SEASON_SHORTNAME, 'SAP_Category_Desc__c' AS SF_FIELDNAME,  B.CATEGORY_DESC AS FIELDVALUE, 993 AS SORT_ORDER, SEGMENT_COUNT, CREATE_DATE, MODIFIED_DATE 
FROM MAT_DELTA_SF_STAGING A INNER JOIN SAPCATEGORYDESC_UNIQUE B ON A.MAGTEMPLATES_ID = B.MAGTEMPLATES_ID AND A.ROW_ID = B.ROW_ID
WHERE A.SF_FIELDNAME = 'Planning_Choice__c'
AND A.SEASONS_ID IN (SELECT ID FROM SEASONS WHERE TRACK_DELTA = 'Y' AND INITIAL_DATA_LOADED = 'Y')
AND A.MODIFIED_DATE > P_SF_LASTRUNDATETIME;
COMMIT;
...
SELECT A.MAG_ID, A.MAG_NAME, A.MAGTEMPLATES_ID, A.MAGTEMPLATES_NAME, 
A.ROW_ID, A.BRAND_ID, A.BRAND_NAME, A.SEASONS_ID, 
A.SEASON_YEAR, A.SEASON_NAME, A.SEASON_SHORTNAME, 'Flex_Color_Marketing_Name__c' AS SF_FIELDNAME,  B.COLOR_MARKETING_NAME AS FIELDVALUE, 992 AS SORT_ORDER, SEGMENT_COUNT, CREATE_DATE, MODIFIED_DATE 
FROM MAT_DELTA_SF_STAGING A INNER JOIN COLORMARKETTINGNAME_UNIQUE B ON A.MAGTEMPLATES_ID = B.MAGTEMPLATES_ID AND A.ROW_ID = B.ROW_ID
WHERE A.SF_FIELDNAME = 'Planning_Choice__c'
AND A.SEASONS_ID IN (SELECT ID FROM SEASONS WHERE TRACK_DELTA = 'Y' AND INITIAL_DATA_LOADED = 'Y')
AND A.MODIFIED_DATE > P_SF_LASTRUNDATETIME;
COMMIT;
