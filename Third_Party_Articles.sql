...
SELECT DISTINCT LTRIM(MARA.MATNR,'0') ARTICLE__c, TO_CHAR(SUBRAND.ZZ_SUBRAND1) SUBRAND__c, TO_CHAR(SUBRAND.DESCR) SUBRAND_DESCR__c, 
       ...
       MATDATA.DIGITAL_DROP_5__C, TO_CHAR(TO_DATE(MATDATA.DIGITAL_ON_FLOOR__C,'MM/DD/YYYY'), 'YYYY-MM-DD') as DIGITAL_ON_FLOOR, 
       TO_CHAR(TO_DATE(MATDATA.DIGITAL_OFF_FLOOR__c,'MM/DD/YYYY'), 'YYYY-MM-DD') as DIGITAL_OFF_FLOOR,
       TO_CHAR(TO_DATE(MATDATA.Digital_Adoption_Time_Stamp__c,'MM/DD/YYYY, HH:MI:SS AM'), 'YYYY-MM-DD HH:MI:SS') as DIG_ADOPT_TIME_STAMP,
       TO_CHAR(TO_DATE(MATDATA.Store_Adoption_Time_Stamp__c,'MM/DD/YYYY, HH:MI:SS AM'), 'YYYY-MM-DD HH:MI:SS') as STORE_ADOPT_TIME_STAMP,
       TO_CHAR(TO_DATE(MATDATA.Int_Adoption_Time_Stamp__c,'MM/DD/YYYY, HH:MI:SS AM'), 'YYYY-MM-DD HH:MI:SS') as INT_ADOPT_TIME_STAMP
